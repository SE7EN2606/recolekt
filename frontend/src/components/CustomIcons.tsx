...
export const CustomMessageSquareMoreIcon = ({ size = 16, className = "", style }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style} aria-hidden="true">
    ...
    <path d="M12 11h.01"></path><path d="M16 11h.01"></path><path d="M8 11h.01"></path>
  </svg>
);

export const IOSShareIcon = ({ size = 24, className = "", style }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
    <path d="M12 2v13"/><path d="m16 6-4-4-4 4"/><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/>
  </svg>
);

export const InstagramExternalIcon = ({ size = 16, className = "", style }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
    <path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>
  </svg>
);

export const FacebookExternalIcon = ({ size = 16, className = "", style }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
  </svg>
);

export const LayersIcon = ({ size = 24, className = "", style }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const HashIcon = ({ size = 16, className = "", style }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style} aria-hidden="true">
...
export const TagsIcon = ({ size = 24, className = "", style }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const CategoryIcon = ({ size = 16, className = "" }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={{ color: 'rgb(139, 92, 246)' }}>
    <path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"></path>
    <path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"></path>
    <path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"></path>
  </svg>
...
export const TopicIcon = ({ size = 16, className = "" }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true" style={{ color: 'rgb(225, 29, 72)' }}>
    <line x1="4" x2="20" y1="9" y2="9"></line><line x1="4" x2="20" y1="15" y2="15"></line>
    <line x1="10" x2="8" y1="3" y2="21"></line><line x1="16" x2="14" y1="3" y2="21"></line>
  </svg>
);

export const HashtagsIcon = ({ size = 16, className = "" }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 512 512" fill="currentColor" className={className} aria-hidden="true" style={{ color: 'rgb(8, 145, 178)' }}>
...
// ── Platform Author Icon (small, beside author name) ──────────────────────────
export const PlatformIconAuthor = ({ platform }: { platform: string }) => {
...
// ── Platform Button Icon (inside CTA buttons, always white) ───────────────────
export const PlatformIconBtn = ({ platform, size = 16, className }: { platform: string; size?: number; className?: string }) => {
  if (platform === 'facebook' || platform === 'fb') {
    return (
      <svg width={size} height={size} fill="currentColor" viewBox="0 0 24 24" className={className ?? "text-white flex-shrink-0"}>
        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
      </svg>
    );
  }
...
// ── Platform CTA Button (full button component) ───────────────────────────────
export const PlatformButton = ({ platform, url, t }: { platform: string; url: string; t: (key: string, fallback: string) => string }) => {
  const config: Record<string, { bg: string; hover: string; label: string }> = {
    instagram: {
      bg: 'bg-gradient-to-r from-[#F58529] via-[#DD2A7B] to-[#8134AF]',
      hover: 'hover:opacity-90',
      label: t('videoDetail:viewOnInstagram', 'View on Instagram'),
    },
    facebook: {
      bg: 'bg-[#1877F2]',
      hover: 'hover:bg-[#166FE5]',
      label: t('videoDetail:viewOnFacebook', 'View on Facebook'),
    },
    youtube: {
      bg: 'bg-[#FF0000]',
      hover: 'hover:bg-[#CC0000]',
      label: t('videoDetail:viewOnYouTube', 'View on YouTube'),
    },
    tiktok: {
      bg: 'bg-black',
      hover: 'hover:bg-gray-900',
      label: t('videoDetail:viewOnTikTok', 'View on TikTok'),
    },
  };

  const c = config[platform] ?? config.instagram;

  return (
    <a href={url} target="_blank" rel="noreferrer" className="block w-full">
      <button className={`w-full flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-white font-bold text-sm shadow-sm transition ${c.bg} ${c.hover}`}>
        <PlatformIconBtn platform={platform} size={16} className="text-white flex-shrink-0" />
        {c.label}
      </button>
    </a>
  );
