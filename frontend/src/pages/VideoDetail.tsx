...
export const VideoDetail: React.FC = () => {
  ...
  // 🔥 PERFECT SCROLL-LOCK & JITTER FIX FOR CHROME/BRAVE/SAFARI
  useEffect(() => {
             ...
             <div className="pb-3 mb-3 border-b border-violet-200/70 relative flex items-center">
                <div className="flex flex-col gap-2 pr-10 flex-1">
                   <div className="flex items-center gap-2">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 text-violet-600"><path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"></path><path d="M2 12a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 12"></path><path d="M2 17a1 1 0 0 0 .58.91l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9A1 1 0 0 0 22 17"></path></svg>
                      <span className="text-xs font-bold uppercase tracking-wide truncate text-violet-600">{viewModel.category}</span>
                   </div>
                   <div className="flex items-center gap-2">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 text-pink-600" aria-hidden="true"><line x1="4" x2="20" y1="9" y2="9"></line><line x1="4" x2="20" y1="15" y2="15"></line><line x1="10" x2="8" y1="3" y2="21"></line><line x1="16" x2="14" y1="3" y2="21"></line></svg>
                ...
                <div className="p-5 flex flex-col gap-2 hover:bg-gray-50/50 transition-colors border-b border-gray-50">
                   <div className="flex items-center gap-2">
                      <div className="p-1.5 bg-violet-50 text-violet-600 rounded-md">
                         <LayersIcon size={16} style={{ color: 'rgb(139, 92, 246)' }} />
                      </div>
                  ...
                  <div className="p-5 border-t border-gray-50 flex flex-col gap-2 hover:bg-gray-50/50 transition-colors">
                     <div className="flex items-center gap-2">
                        <div className="p-1.5 bg-pink-50 text-pink-600 rounded-md">
                           <HashIcon size={16} style={{ color: 'rgb(225, 29, 72)' }} />
                        </div>
                ...
                <div className="p-5 border-t border-gray-50 bg-gray-50/30">
                   <div className="flex items-center gap-2 mb-3">
                      <div className="p-1.5 bg-cyan-50 text-cyan-600 rounded-md">
                         <TagsIcon size={16} style={{ color: 'rgb(8, 145, 178)' }} />
                      </div>
                 ...
                 <a href={viewModel.originalUrl} target="_blank" rel="noreferrer" className="block">
                    {viewModel.platform === 'facebook' ? (
                      <button className="w-full flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-white font-bold text-sm shadow-md transition bg-[#1877F2] hover:bg-[#166FE5]">
                        <FacebookExternalIcon size={16} className="text-white" />
                        View on Facebook
                      </button>
                    ) : (
