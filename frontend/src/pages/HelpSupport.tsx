...
export const HelpSupport: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Handle deep linking with a small timeout
    ...
    <div className="max-w-2xl mx-auto pb-20 animate-fade-in">
      ...
      <div className="space-y-12">
        ...
        <section id="how-to" ref={howToRef} className="scroll-mt-24">
          <SectionHeader title="How to Pin" />
          <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm p-8">
            <div className="flex items-center gap-4 mb-10">
               ...
               <div>
                  <h4 className="text-2xl font-black text-gray-900 tracking-tight">Pinning Content</h4>
                  <p className="text-gray-400 text-[10px] font-black uppercase tracking-widest">Build your library in seconds</p>
               </div>
            </div>
            
            <div className="space-y-10">
              {[
                { s: 1, t: "Copy link from Instagram", d: "Open any public Reel, tap share, and select 'Copy Link'." },
                { s: 2, t: "Paste in Recolekt", d: "Come back here and paste it into the main search bar on the home screen." },
                { s: 3, t: "AI Magic", d: "We'll automatically extract the category, summary, and bullet points for you." }
              ].map(step => (
        ...
        <section id="contact" ref={contactRef} className="scroll-mt-24">
          ...
          <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm p-8">
            <p className="text-gray-500 font-medium mb-8 leading-relaxed text-sm">Have questions about your plan or facing a technical bug? Our team is available 24/7.</p>
            <div className="space-y-4">
              <a href="mailto:support@recolekt.app" className="block p-6 bg-gray-50 rounded-[24px] border border-gray-100 hover:border-primary-200 transition-all group shadow-sm hover:shadow-md">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <span className="block font-black text-gray-900 tracking-tight text-lg">Email Support</span>
              ...
              <div className="p-6 bg-gray-50 rounded-[24px] border border-gray-100 opacity-60 flex items-center gap-5">
                ...
                <div>
                  <span className="block font-black text-gray-900 tracking-tight text-lg">Priority Chat</span>
                  <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">PRO EXCLUSIVE</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="about" ref={aboutRef} className="scroll-mt-24">
          ...
          <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm p-10 text-center">
            ...
            <div className="pt-8 border-t border-gray-50 flex flex-col items-center">
              <span className="text-[10px] font-black text-gray-300 uppercase tracking-widest">Version 1.0.4 (Stable)</span>
              <span className="text-[10px] font-black text-gray-300 uppercase tracking-widest mt-1">© 2025 Recolekt Labs. Worldwide.</span>
            </div>
          </div>
        </section>
      </div>
