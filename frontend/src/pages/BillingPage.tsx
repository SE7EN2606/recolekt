...
export const BillingPage: React.FC = () => {
  ...
  const handleAction = () => {
    if (user) {
      ...
      // User is guest, go to auth then gallery (where they would normally see upgrade prompt again)
      navigate('/auth');
    }
  };
    ...
    <div className="max-w-3xl mx-auto pb-20 animate-fade-in md:px-0">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6 text-gray-900 leading-tight">
          Unlock your full <br/>
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-500">creative potential.</span>
        </h1>
