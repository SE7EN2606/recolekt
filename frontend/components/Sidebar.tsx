  ...
  const linkClass = (active: boolean) => `
    ...
    ${
      active
        ...
        : 'bg-transparent text-gray-600 border-transparent hover:bg-gray-50 hover:text-primary-900'
    }
  `;
        ...
        <div className="mb-6 flex-1">
          ...
          <div className="space-y-1 px-2">
                    ...
                    {({ isActive }) => (
                      <>
                        <div className="flex items-center gap-3 min-w-0">
                          {/* RULE: main folder icon always FolderClosed */}
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                          ...
                          {/* Keep right chevron so user understands there are subfolders */}
                          {hasSubs && (
                        ...
                        <NavLink
                          ...
                          className={({ isActive }) => `
                            ...
                            ${
                              isActive
                                ? 'bg-primary-50 text-primary-900 font-bold border-primary-100'
                                : 'bg-transparent text-gray-500 border-transparent hover:bg-gray-50 hover:text-primary-900'
                            }
                          `}
                        >
                          {({ isActive }) => (
                            <div className="flex items-center gap-2 flex-1 min-w-0">
                              {/* RULE: subfolder icon FolderOpen */}
            ...
            {customFolders.length === 0 && (
              <div
                onClick={() => setIsInputModalOpen(true)}
                className="p-4 border-2 border-dashed border-gray-100 rounded-xl text-center cursor-pointer hover:border-primary-200 hover:bg-primary-50/30 transition-all group"
              >
