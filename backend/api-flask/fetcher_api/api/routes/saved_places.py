            ...
            if video_id:
                cur.execute(
                    ...
                    SELECT id, video_id, place_index, name, type,
                           city, region, country, address, description,
                           instagram, lat, lng, rank
                    FROM   saved_places
        ...
        with conn.cursor() as cur:
            cur.execute(
                ...
                INSERT INTO saved_places
                    (user_id, video_id, place_index, name, type, city, region,
                     country, address, description, instagram, lat, lng, rank)
                VALUES
